...
import QuoteWebView from './pages/QuoteWebView';
      ...
      <>
        <Router>
          <Routes>
            ...
            {/* Public Quote Web View - No login required (for mobile app WebView) */}
            <Route path="/quote-view/:quoteId" element={<QuoteWebView />} />
