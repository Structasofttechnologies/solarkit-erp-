...
// Partner Industry Types
export const getPartnerIndustryTypes = async (partnerType) => {
    const params = {};
    if (partnerType) params.partnerType = partnerType;
    const res = await api.get('/partner-settings/industry-types', { params });
    return res.data;
};
export const createPartnerIndustryType = async (data) => {
    const res = await api.post('/partner-settings/industry-types', data);
    return res.data;
};
export const deletePartnerIndustryType = async (id) => {
    const res = await api.delete(`/partner-settings/industry-types/${id}`);
    return res.data;
};

// Partner Professions
export const getPartnerProfessions = async (partnerType, stateId, plan, industryTypeId) => {
    const params = {};
    if (partnerType) params.partnerType = partnerType;
    if (stateId) params.stateId = stateId;
    if (plan) params.plan = plan;
    if (industryTypeId) params.industryTypeId = industryTypeId;
...
export const createPartnerUser = async (data) => {
    const res = await api.post('/partner-settings/users', data);
    return res.data;
};
export const getPartnerUsers = async (filters = {}) => {
    const res = await api.get('/partner-settings/users', { params: filters });
    return res.data?.data || res.data;
};
export const getPartnerUserById = async (id) => {
    const res = await api.get(`/partner-settings/users/${id}`);
    return res.data?.data || res.data;
};
export const updatePartnerUser = async (id, data) => {
    const res = await api.put(`/partner-settings/users/${id}`, data);
    return res.data;
};
export const deletePartnerUser = async (id) => {
    const res = await api.delete(`/partner-settings/users/${id}`);
    return res.data;
};
export const getPartnerUserCounts = async () => {
    const res = await api.get('/partner-settings/users/counts');
    return res.data?.data || {};
};

// Business Types
export const getBusinessTypes = async () => {
    const res = await api.get('/partner-settings/business-types');
    return res.data?.data || [];
};
export const createBusinessType = async (data) => {
    const res = await api.post('/partner-settings/business-types', data);
    return res.data?.data || res.data;
};
export const deleteBusinessType = async (id) => {
    const res = await api.delete(`/partner-settings/business-types/${id}`);
    return res.data;
};

// GST Partner Config
export const getGSTPartnerConfigs = async () => {
    const res = await api.get('/partner-settings/gst-partner-config');
    return res.data?.data || [];
};
export const createGSTPartnerConfig = async (data) => {
    const res = await api.post('/partner-settings/gst-partner-config', data);
    return res.data?.data || res.data;
};
export const updateGSTPartnerConfig = async (id, data) => {
    const res = await api.put(`/partner-settings/gst-partner-config/${id}`, data);
    return res.data?.data || res.data;
};
export const deleteGSTPartnerConfig = async (id) => {
    const res = await api.delete(`/partner-settings/gst-partner-config/${id}`);
    return res.data;
};
