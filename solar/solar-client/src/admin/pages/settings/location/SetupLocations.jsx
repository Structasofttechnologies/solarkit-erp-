                ...
                <LocationSelector
                  ...
                  showLevels={
                    activeTab === 'states' ? ['country'] :
                      activeTab === 'districts' ? ['country', 'state'] :
                        activeTab === 'clusters' ? ['country', 'state', 'district'] :
                          activeTab === 'zones' ? ['country', 'state', 'cluster', 'district'] :
                            activeTab === 'cities' ? ['country', 'state', 'cluster', 'zone', 'district'] : null
                  }
                  multiple={{
                  ...
                  fetchParams={{
                    district: activeTab === 'clusters' ? { 
                      unassignedToCluster: true,
                      editingClusterId: editingId 
                    } : {}
                  }}
                />
              )}
