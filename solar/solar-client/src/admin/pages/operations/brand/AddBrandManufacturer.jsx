...
const AddBrandManufacturer = () => {
  ...
  const addManufacturer = async () => {
    if (!form.companyName || !form.companyOriginCountry || !form.brand || !form.state) {
      alert('Please fill all required fields (Company Name, Brand, and at least State)');
      return;
    }
    try {
  ...
  const resetForm = () => {
    setForm({
      ...
      brand: '', brandLogo: null, comboKit: false
    });
    setClusters([]);
    setDistricts([]);
    setCities([]);
            ...
            <div>
              ...
              <div className="flex items-center gap-4">
                ...
                />
                 {form.brandLogo && (
                  <img
                    src={getImageUrl(form.brandLogo)}
                  ...
                  <tr key={manufacturer._id} className="border-b hover:bg-gray-50">
                    <td className="p-3">
                      {manufacturer.brandLogo ? (
                        <img
                          src={getImageUrl(manufacturer.brandLogo)}
                          alt="Logo"
                          className="w-10 h-10 object-contain"
                        />
                      ) : (
